...
[@plexigraph/aninest](../README.md) / changeInterpFunction

# Function: changeInterpFunction()

> **changeInterpFunction**\<`Animating`\>(`anim`, `interp`, `mask`): `void`
...
• **interp**: [`Interp`](../type-aliases/Interp.md)
...
[Animate/Animatable.ts:579](https://github.com/plexigraph/aninest/blob/b607a0c/src/Animate/Animatable.ts#L579)
